    ...
    return (
        <Popover>
            <PopoverTrigger asChild className="login-popover-trigger">
                <Button
                    className="relative px-3 border-1 border-t-0 h-full rounded-2xl rounded-t-none bg-background border-border text-foreground hover:bg-accent font-medium flex flex-col gap-1 overflow-hidden"
            ...
            <PopoverContent className="mt-1 mr-2 flex flex-col gap-2">
                ...
                >
                    <LogIn /> {t('actions.sign_in_with') + ' Google'}
                </Button>
                <Button
